...
regime_change=function(delP,delT){
  ...
  dir=("F:\\USU_Research_work_update_March_30_2014\\RAINFALL_COMPARISON\\B1_watershed\\PRISM_RUN")
  setwd(dir)
...
write.table(rg,"B1_PT_PR_sensi.txt",row.names=FALSE,col.names=FALSE) ## A1_PT_DY_sensi.txt== A1 watershed precipitation and temperature sensitivity combined for the Daymet data sets.
